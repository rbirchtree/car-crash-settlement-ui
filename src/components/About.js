            ...
            <Helmet>
                ...
                <div className="row">
                    <div className="col-sm">
                            <p><img className="rounded-circle float-right" src={rob} alt="Rob" />Rob Birch is a software engineer who was involved in a rear end collusion and his car was totaled in it.
